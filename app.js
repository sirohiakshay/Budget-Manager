...
var UIController = (function () {
    ...
    var formatNumber = function(num, type){
            ...
            num = Math.abs(num);
            num = num.toFixed(2); //exact 2 decimal places,its a string now
    ...
    //self made function like array forEach
    ...
    return{
        getInput: function() {
            return{
                type: document.querySelector(DOMstrings.inputType).value,  //wiil be inc or exp
